...
with profile.group_manager(
    ...
    g(['arb_internalformat_query2-generic-pname-checks'], 'misc. Individual most generic pname checks')
    ...
    g(['arb_internalformat_query2-max-dimensions'], 'misc. Max dimensions related pname checks')
