...
bool gfunc(dmat4 x[2][2][2][2][2][2][2][2], inout dmat4 y[2][2][2][2][2][2][2][2])
{
                    ...
                    for (uint e = 0u; e < 2u; e++)
                    {
                        for (uint f = 0u; f < 2u; f++)
                        {
                           for (uint g = 0u; g < 2u; g++)
                           {
                               for (uint h = 0u; h < 2u; h++)
                               {
                                   if(x[a][b][c][d][e][f][g][h][0][0] != double(((a*128u)+(b*64u)+(c*32u)+(d*16u)+(e*8u)+(f*4u)+(g*2u)+h))) {return false;}
                                   }
                           }
                        }
                    }
